...
const NavbarDefault = ({ headerstyle, isLogin }) => {
    ...
    <Fragment>
      ...
      >
        <Container fluid className="px-0 ps-2">
          ...
          <div
            className={`navbar-nav navbar-right-wrap ms-auto d-lg-none nav-top-wrap ${isLogin ? (isDesktop || isLaptop ? "d-none" : "d-flex") : "d-none"
              }`}
          >
            <QuickMenu />
          </div>
